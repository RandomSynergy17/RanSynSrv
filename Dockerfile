...
RUN sh -c "$(wget -O- https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" "" --unattended && \
    ...
    printf '%s\n' \
        ...
        > ~/.zprofile
# .zshrc is shipped as a real file at root/home/abc/.zshrc and copied into
# place by the `COPY root/ /` step further down. Keeping it out of an inline
# heredoc makes hadolint (and every other Dockerfile linter) happy, and makes
# the file directly editable without touching build plumbing.
USER root
