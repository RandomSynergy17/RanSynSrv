...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container { text-align: center; padding: 2rem; max-width: 720px; width: 100%; }
        h1 {
            font-size: 2.5rem;
        ...
        a:hover { background: #e94560; color: #fff; }
...
<body>
    <div class="container">
        <h1>RanSynSrv</h1>
        <p class="subtitle">Nginx + PHP <?= PHP_MAJOR_VERSION . '.' . PHP_MINOR_VERSION ?> + GoAccess + Claude Code</p>
        <div class="links">
